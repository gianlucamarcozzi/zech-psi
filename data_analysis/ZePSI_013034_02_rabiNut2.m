...
load('../data/processed/ZePSI-E-013034-Nut2.mat')
nMeas = numel(x);
...
rabiFreqAvg = sum(freq*1e3./deltapci')/sum(1./deltapci);
rabiPiPulse = 1/2/rabiFreqAvg*1e3;
fprintf("Average Rabi frequency: %.2f, Rabi pi pulse: %.2f\n", ...
    rabiFreqAvg, rabiPiPulse)

...
%% PULSE 2
loadPath = '../data/processed/ZePSI-E-014-012-Nut2.mat';
pul2 = load(loadPath);
nMeas = numel(pul2.x);
...
save("../data/processed/ZePSI-E-014-012-pPhases.mat", "pPhases", "-mat")
...
figure(16)
clf; hold on; box on;
plot(1:nMeas, amprm1{1}/max(amprm1{1}), 'o-')
plot(1:nMeas, amptm1{1}/max(amptm1{1}), 'o-')
plot(1:nMeas, freqRabi/max(freqRabi), 'o-')

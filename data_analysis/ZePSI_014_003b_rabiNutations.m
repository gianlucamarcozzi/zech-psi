...
%% PULSE 2
pul2 = load('../data/processed/ZePSI-E-014003-Nut2.mat');
nMeas = numel(pul2.x);
...
%% PULSE 1
loadPath = '../data/processed/ZePSI-E-014003-Nut1.mat';
pul1 = load(loadPath);
nMeas = numel(pul1.x);
...
% Plot frequencies with uncertainties
for ii = 1:nMeas
    mpfuAmp(ii) = param{ii}.mpfuAmpPulse1;
end
nexttile
errorbar(mpfuAmp, freqRabi, dfreqRabi, 'o')
xlim(setaxlim(mpfuAmp, 1.05))
